...
const Login = () => { 
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://localhost:3000/accountLogin', values)
      .then(res => {
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <Link to="/create" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</Link>
                  </p>
              </form>
          </div>
      </div>
